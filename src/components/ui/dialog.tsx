...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-full p-2 bg-black hover:bg-zinc-900 text-white border-2 border-black shadow-2xl transition-all hover:scale-110 focus:outline-none disabled:pointer-events-none">
        <X className="h-5 w-5" />
